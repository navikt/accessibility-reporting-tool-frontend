...
exports.CollapsibleTrigger = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (react_1.default.createElement(Comp, Object.assign({ ref: ref, type: "button", "data-state": ctx.state, onClick: (0, composeEventHandlers_1.composeEventHandlers)(onClick, ctx.onOpenToggle), "aria-expanded": ctx.open }, rest, { id: ctx.triggerId, "aria-controls": ctx.open ? ctx.contentId : undefined }), children));
});
