 ...
 * ```
 */
exports.Ingress = (0, react_1.forwardRef)((_a, ref) => {
    var { className, spacing, as: Component = "p" } = _a, rest = __rest(_a, ["className", "spacing", "as"]);
    return (react_1.default.createElement(Component, Object.assign({}, rest, { ref: ref, className: (0, clsx_1.default)(className, "navds-ingress", {
            "navds-typo--spacing": !!spacing,
        }) })));
});
exports.default = exports.Ingress;
