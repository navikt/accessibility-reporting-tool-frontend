        ...
        <main>
            ...
            <section className={styles.section2}>
                ...
                <article className={styles.article}>
                    ...
                    <p className={styles.verktoyTekst}>Dette er noen av verktøyene vi anbefaler for rapportering</p>
                </article>

                <article className={styles.article}>
                    <ComponentIcon title="code icon" fontSize="3rem" />
                    <Heading size="medium">Les mer på <Link href="https://aksel.nav.no/">Aksel.no</Link></Heading>
                </article>

                <article className={styles.article}>
                    <FigureIcon title="accessibility figure icon" fontSize="3rem" />
                    <Heading size="medium">Les mer på <Link href="https://www.uutilsynet.no/">uutilsynet.no</Link></Heading>
                </article>
            </section>
        </main>
    )
                ...
                <Tabs.Panel value="mittTeam" className="h-24 w-full bg-gray-50 p-4">
                    ...
                    <section className={styles.gridWrapper}>
                        ...
                        <section className={styles.reportsContainer}>
                            <Heading size="large" spacing>Rapporter</Heading>
                            <RapportListe/>
                            <Heading size="large" spacing>Samlerapporter</Heading>
                        </section>
                    </section>
                </Tabs.Panel>
                <Tabs.Panel value="mineRapporter" className="h-24 w-full bg-gray-50 p-4">
                    <h1>Mine-rapporter-tab</h1>
